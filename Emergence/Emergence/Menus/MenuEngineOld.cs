...
namespace Emergence
{
    ...
    public class MenuEngine2
    {
        ...
        public void Update()
        {
            ...
            Update(coreEngine.currentState, coreEngine.inputEngine.getMenuKeys(), coreEngine.inputEngine.getLook()-currentMenu.offset);           
            Update(coreEngine.currentState, coreEngine.inputEngine.getMenuButtons(0), coreEngine.inputEngine.getLook(0)-currentMenu.offset);  
